# Données extraites de l'Excel Florian — seed pour le paramétrage du CRM
...
> **Note de versioning** : ce fichier était précédemment nommé `aloura-donnees-excel-extraites.md`. Le préfixe "aloura" faisait référence à l'ancienne équipe de développement qui n'est plus sur le projet et n'a jamais désigné le CRM lui-même. Renommage appliqué le 22 avril 2026.
...
Note : ALPHAND distingue ambulatoire (350 €) et hospitalisation (650 €).
...
**Implication** : chaque intervention a un prix d'honoraires qui peut évoluer dans le temps. Le coefficient de "marge" est stocké mais pas montré au patient. La durée peut varier selon la clinique.
...
**Implication** : les actes de médecine esthétique ont une logique différente des chirurgies (pas de frais bloc/anesthésie, mais des forfaits multi-séances). Flag `type` (chirurgie vs médecine esthétique) nécessaire sur la table `Intervention`.
...
**Implication** : suivis en volume et CA mensuel. Pas forcément dans le MVP chirurgie mais à prévoir dans `Intervention` avec flag `type = "soin"`.
...
|---|---|---|
| Règlements Chirurgie (colonnes A-S) | Suivi patient avec noms, dates, montants | Données patients personnelles |
...
| Données patients | Présentes mais ignorées | Non (pas MVP) |
| Données CA / primes / compta | Présentes | Non (pas MVP) |

---

## 10. Frais supplémentaires à prévoir pour le seed (v1.4+)

Exemples d'`InterventionFee` réalistes à ajouter en seed pour les interventions clés :

| Intervention | Frais supplémentaire | Prix par défaut | Qty |
|---|---|---|---|
| Prothèses mammaires | Implants Motiva | 1 800 € | 2 |
| Pexie | Implants Motiva (si associé) | 1 800 € | 2 |
| Changement de Prothèses | Nouveaux implants | 1 800 € | 2 |
| Lipoedème Mollets + Genoux | Kit consommables | 250 € | 1 |
| Lipoedème Cuisses | Kit consommables | 350 € | 1 |
| Renuvion 1 zone | Kit Renuvion | 800 € | 1 |
| Renuvion 2 zones | Kit Renuvion | 1 600 € | 1 |
| Lipo Bras VASER | Sondes VASER | 450 € | 1 |

---

## 11. Document labels à prévoir pour le seed (v1.5+)

Labels génériques réutilisables associés aux interventions chirurgicales :

| Document label | Description | Obligatoire par défaut |
|---|---|---|
| Bilan sanguin | Bilan biologique pré-op récent (< 1 mois) | Oui |
| Consultation anesthésiste | Compte-rendu de la consultation pré-anesthésique | Oui |
| Consentement éclairé | Formulaire de consentement signé | Oui |
| Photos face | Photos de face (pré-op) | Oui |
| Photos profil | Photos de profil gauche/droit (pré-op) | Oui |
| Photos dos | Photos de dos (pré-op) — pour lipo, BBL | Oui |
| Ordonnance pré-op | Ordonnance médicaments pré-op | Oui |
| Mammographie | Récente (< 1 an) — pour prothèses, pexie | Oui |
| Échographie mammaire | Récente (< 1 an) — pour prothèses, pexie | Oui |
| ECG | Électrocardiogramme récent | Oui |
| Pièce d'identité | CNI ou passeport | Oui |

Associations types à seeder :
- Toute chirurgie : Bilan sanguin, Consultation anesthésiste, Consentement éclairé, Ordonnance pré-op, Pièce d'identité, ECG
- Interventions mammaires (Prothèses, Pexie, Changement) : + Mammographie, Échographie mammaire, Photos face + profil
- Lipo 360, BBL, Abdominoplastie : + Photos dos, Photos face + profil
- Médecine esthétique : aucun document obligatoire par défaut

---

## 12. Questions à lever avec Florian

- Les prix listés sont "fin 2024". Faut-il utiliser ces prix pour le seed ou il a des prix 2025/2026 mis à jour ?
- Le coefficient de marge (ex : 4.5) est-il un multiplicateur interne ou un ratio ? Interprétation exacte ?
- Les durées d'opération qui varient entre CEPE et la colonne "ITV" : laquelle est la bonne pour le calcul du devis ?
...
- Les frais supplémentaires listés en §10 sont indicatifs. À valider/compléter avec Florian avant le seed.
- Les document labels en §11 sont une proposition. À valider avec Florian et le chirurgien partenaire.
